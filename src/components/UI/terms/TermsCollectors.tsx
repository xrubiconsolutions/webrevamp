...
import { Wrapper } from "./TermsGenerators";
const TermsCollectorSection = styled.section`
  ${tw`py-20`}
`;
...
const TermsCollectors = () => {
  return (
    // <TermsCollectorSection>
    //   <BodyP>
    //     These General Terms set forth the main terms and conditions applying to
    //     and governing the usage of the Pakam Services. In order to provide
    //     collection Services via using the Pakam Platform you must agree to the
    //     terms and conditions that are set forth below.
    //   </BodyP>

    //   <Bodyh6>1. DEFINITIONS</Bodyh6>
    //   <BodyP>
    ...
    //     office 127 Ogunlana Drive, Surulere Lagos, Nigeria, or other Pakam group
    //     company or cooperation partner where Pakam Services are not provided by
    //     Pakam Operations. In order to use Pakam app you must agree to the terms
    //     and conditions that are set out below:
    //   </BodyP>
    //   <BodyP>
    //     1.2. Pakam Services – services that Pakam provides, including provision
    //     and maintenance of Pakam App, Pakam insight Platform, In-app Payment,
    //     customer support, communication between the collector and the generator
    //     and other similar services.
    //   </BodyP>
    //   <BodyP>
    //     1.3. Pakam App – a smartphone application for collector and generator to
    //     Schedule and accept Collection Services
    //   </BodyP>
    //   <BodyP>
    //     1.4. Pakam Platform – technology connecting Generators with Collectors
    //     to help them dispose their waste more efficiently smartly and on-demand.
    //   </BodyP>
    //   <BodyP>
    //     1.5. Generator – a person scheduling Collection Services by using Pakam
    //     Platform.
    //   </BodyP>
    //   <BodyP>
    ...
    //     <BodyP>1.7.1. these General Terms;</BodyP>
    //     <BodyP>
    //       1.7.2. special terms displayed in Pakam App, e.g regarding price info
    //       or service descriptions;
    //     </BodyP>
    //     <BodyP>1.7.3. the Collector’s guidelines; and</BodyP>
    //     <BodyP>
    ...
    //     Services.
    //   </BodyP>
    //   <Bodyh6>2. ENTRY INTO THE AGREEMENT</Bodyh6>
    //   <BodyP>
    ...
    //     either as a legal or a natural person. Upon successful completion of the
    //     signup application, we will provide you with a personal account
    //     accessible via a username and password. By clicking the „Sign up" button
    //     located at the end of the signup application, you represent and warrant
    //     that:
    //   </BodyP>
    //   <BodyP>
    //     2.1.1. pursuant to valid legal acts, you are entitled to enter into an
    //     agreement with us to use the Pakam Platform for providing the Collection
    //     Service;
    //   </BodyP>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <BodyP>
    //     2.1.3. all the information you have presented to us is accurate, correct
    //     and complete;
    //   </BodyP>
    //   <BodyP>
    ...
    //     unlawful purposes and impair the proper operation of the Pakam Services;
    //   </BodyP>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <BodyP>
    //     2.2. In the case of a waste hauler, you are obliged to provide your bank
    //     requisites in course of filling the payment details upon registration.
    //     In case you are a legal person, you must insert the bank account of the
    //     company. We are transferring In-app Payment fees to the bank account
    //     that you have provided. We are not liable for any incorrect money
    //     transactions in case you have provided wrong bank requisites. We advise
    //     that Haulers and collectors use Pakam Financial institution partner
    ...
    //   </BodyP>
    //   <BodyP>
    //     2.3. After submitting the signup application, you will receive an e-mail
    //     with additional conditions that must be met in order to use Pakam
    //     Services. These conditions may include providing criminal records, valid
    //     driving license, satisfactory technical state of the vehicle, completion
    //     of a training course, owning a GPS-supporting mobile device and other
    //     conditions as described in the pertinent e-mail. The failure to comply
    //     with the provided requirements and conditions may result in termination
    //     of the Agreement and right to use the Pakam Services.
    //   </BodyP>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <BodyP>
    //     2.5. Registering the account as a legal person (i.e. a company). You are
    //     considered to be a legal person, if the recipient of the fees is marked
    //     as a legal person in payment details (as accessible in the Pakam
    //     Collectors Account). In such case, the indicated legal person is
    ...
    //     provide the collection Services. Such natural person may use the account
    //     of the collector only if he/she has read and agrees to be bound by these
    //     General Terms and any further documentation that is part of the
    //     Agreement. THE LEGAL PERSON IN THE PAYMENT DETAILS AND THE NATURAL
    //     PERSON FACTUALLY PROVIDING THE COLLECTION SERVICES UNDER PAKAM ACCOUNT
    //     SHALL REMAIN JOINTLY AND SEVERALLY LIABLE FOR ANY INFRINGEMENT OF THE
    //     GENERAL TERMS AND AGREEMENT CONDUCTED BY THE COLLECTOR.
    //   </BodyP>
    //   <Bodyh6>3. RIGHT TO USE Pakam APP AND Pakam Collectors ACCOUNT</Bodyh6>
    //   <BodyP>
    //     3.1. License to use the Pakam App and the Pakam Collectors Account.
    //     Subject to your compliance with the Agreement, We hereby grant you have
    //     a license to use the Pakam App and the Pakam Collectors Account. The
    ...
    //     attempt to obtain the source code of the Pakam App, the Pakam collectors
    //     Account or other software of Pakam;
    //   </BodyP>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <BodyP>
    //     3.3. The License granted herein revokes automatically and simultaneously
    //     with termination of the Agreement. After termination of the Agreement
    //     you must immediately stop using the Pakam App and the Pakam Collectors
    //     Account and we are entitled to block and delete collectors account
    //     without a prior notice.
    //   </BodyP>
    //   <BodyP>
    //     3.4. Using tags and labels of Pakam. Additionally, we may give you tags,
    //     labels, stickers or other signs that refer to Pakam brand or otherwise
    //     indicate you are using the Pakam Platform. We grant you a non-exclusive,
    //     non-sublicensable, non- transferable license to use such signs and only
    //     for the purpose of indicating you are providing Collection Services via
    //     the Pakam Platform. After termination of the Agreement you must
    //     immediately remove and discard any signs that refer to Pakam brand.
    //   </BodyP>
    //   <BodyP>
    //     3.5. All copyrights and trademarks, including source code, databases,
    //     logos and visual designs are owned by Pakam and protected by copyright,
    //     trademark and/or trade secret laws and international treaty provisions.
    //     By using the Pakam Platform or any other Pakam Services you do not
    //     acquire any rights of ownership to any intellectual property.
    //   </BodyP>
    //   <Bodyh6>4. PROVIDING THE COLLECTION SERVICES</Bodyh6>
    //   <BodyP>
    //     4.1. The Collector’s Obligations. You hereby guarantee to provide
    //     Transportation Services in accordance with the General Terms, Agreement
    //     as well as laws and regulations applicable in the state where you are
    //     providing Collection Services. Please note that you are fully liable for
    //     any violation of any local laws and regulations as may arise from
    //     providing Collection Services.
    //   </BodyP>
    //   <BodyP>
    //     4.2. You must have all licenses (including a valid driver’s license),
    //     regulatory permits, car insurance, liability insurance (if applicable),
    //     registrations, certifications and other documentation that are required
    //     in the applicable jurisdiction for providing the Collection Services. It
    //     is your obligation to maintain the validity of all aforementioned
    //     documentation. Pakam reserves the right to require you to present
    //     evidence and submit for review all the necessary licenses, permits,
    //     approvals, authority, registrations, and certifications.
    //   </BodyP>
    //   <BodyP>
    ...
    //     services and endeavour to perform the generators's schedule in the best
    //     interest of the Generator.
    //   </BodyP>
    //   <BodyP>
    ...
    //     the Collection Services including, but not limited to, fuel, mobile data
    //     plan costs, duty fees, amortization of the vehicle, insurance, relevant
    //     corporate or payroll taxes etc. Please bear in mind that using the Pakam
    //     App may bring about consummation of large amount of data on your mobile
    //     data plan. Thus, we suggest you to subscribe for a data plan with
    ...
    //   <Bodyh6>5. PAKAM FEES</Bodyh6>
    //   <BodyP>
    //     5.1. In order to use the Pakam Services, you are obliged to pay to a fee
    //     (i.e. the Pakam Fee). The Pakam Fee is paid based on the total waste
    //     collected at 15% of the price set for collection on a weekly basis into
    //     a central account which is provided by Pakam. The amount of the Pakam
    //     Fee is made available to you via e-mail, Pakam App, Pakam Collectors
    //     Account or other pertinent means. Please acknowledge that the Pakam Fee
    //     may change from time to time. We shall send you a prior notification of
    //     each such change. Fees will be inclusive of applicable taxes where
    //     required by law. Fees paid by you are final and non-refundable, unless
    //     otherwise determined by Pakam.
    //   </BodyP>
    //   <BodyP>
    //     5.2. You must pay the Pakam Fee and any other fees due to us for the
    //     previous week at latest by the 2 nd day of the following week. Upon
    ...
    //   </BodyP>
    //   <Bodyh6>6. IN-APP PAYMENTS</Bodyh6>
    //   <BodyP>
    //     6.1. We may enable Generator/collector to pay for the Collection Service
    //     via cards, carrier billing and other payment methods (Pakam Business
    //     etc) directly in the Pakam App (i.e. In-app Payment). You hereby
    //     authorise us as your commercial agent to receive the Payment or other
    //     payment paid by the Collector via In-app Payment and to forward relevant
    //     funds to you. Any payment obligation made by the Generator/collector via
    //     the In-app Payment shall be considered fulfilled as of the time that the
    ...
    //   </BodyP>
    //   <BodyP>
    //     6.3. Pakam reserves the right to distribute promo code to collectors at
    //     our discretion on a per promotional basis.
    //   </BodyP>
    //   <Bodyh6>7. CUSTOMER SUPPORT</Bodyh6>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <Bodyh6>8. RATINGS AND ACTIVITY</Bodyh6>
    //   <BodyP>
    //     8.1. In order to guarantee high-quality service and provide additional
    //     reassurance to Generator, you hereby acknowledge that the Generators may
    //     provide you a rating and leave feedback regarding the quality of the
    //     Collection Services that you have provided. Your average rating will be
    //     linked to your Collector´s account and will be available to Generator’s
    //     at Pakam App. If we find out the rating or comment is not given in good
    //     faith, this rating or comment may not be projected in the calculations
    //     of your rating.
    //   </BodyP>
    //   <BodyP>
    ...
    //     regarding accepting, declining, not responding and completing collection
    //     Service requests.
    //   </BodyP>
    //   <BodyP>
    ...
    //     Drivers must establish and maintain. If, after a pertinent notification
    //     from us, you do not increase your average rating or activity score to
    //     minimum level within the prescribed time period, your Collector´s
    //     account will be automatically suspended either temporarily or
    //     permanently. We may reverse the suspension of your account if it is
    //     merited by any external circumstances or it is detected that the
    //     suspension was caused by a system error or false ratings.
    //   </BodyP>
    //   <Bodyh6>9. MARKET OVERVIEWS AND CAMPAIGNS</Bodyh6>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <Bodyh6>10. RELATIONSHIP BETWEEN YOU, US AND THE GENERATOR</Bodyh6>
    //   <BodyP>
    //     10.1. You hereby acknowledge and agree that we provide an information
    //     society service and do not provide Collection Services. By providing the
    //     Pakam Platform and Pakam Services, we act as marketplace connecting
    //     Generator with Collector to enable proper disposal in an efficient
    //     manner. You acknowledge that you are providing the Collection Services
    //     on the basis of a contract for carriage/collection of generators waste
    //     and that you provide the Collection Services either independently or via
    //     a company as an economic and professional activity. Pakam, as the
    //     operator of Pakam App acts as the commercial agent of the Collector for
    //     the mediation of conclusion of contracts between the Collector and the
    //     Generator, and thus, among other things, accepts/ensure payments from/to
    //     the Generator and forwards the payments to the collector/Generator.
    //   </BodyP>
    //   <BodyP>
    ...
    //     also acknowledge that no joint venture or partnership exists between you
    //     and us. You may not act as an employee, agent or representative of us
    //     nor bind any contract on behalf of us. If due to the implication of
    //     mandatory laws or otherwise, you shall be deemed an employee of us, you
    //     hereby agree to waive any claims against us that may arise as a result
    //     of such implied employment relationship.
    //   </BodyP>
    //   <BodyP>
    //     10.3. You may not transfer your rights and obligations deriving from the
    //     General Terms or Agreement to any third party.
    //   </BodyP>
    //   <Bodyh6>11. PROCESSING OF PERSONAL DATA, ACCESS TO DATA</Bodyh6>
    //   <BodyP>
    //     11.1. Your personal data will be processed in accordance with the
    //     Privacy Notice, available at https://pakam.ng/privacy-policy
    //   </BodyP>
    //   <BodyP>
    //     11.2. Pakam has access to all personal data and other data provided or
    //     generated in connection with your use of the Pakam Services. Pakam shall
    //     take all reasonable steps to ensure confidentiality of such data and
    //     comply with all applicable Privacy Policies and laws whenever such data
    //     contains personal data. Except where otherwise provided by applicable
    //     Privacy Policies and laws, Pakam maintains access to such data also
    //     after the Agreement between you and Pakam is terminated.
    //   </BodyP>
    //   <BodyP>
    ...
    //     extent that is made available to you under your Pakam Collectors Account
    //     through Pakam App. You shall take all reasonable steps to ensure
    //     confidentiality of such data and comply with applicable Privacy Policies
    //     and laws as long and to the extent that such data contains personal data
    //     of Generators.
    //   </BodyP>
    //   <Bodyh6>12. LIABILITY</Bodyh6>
    //   <BodyP>
    //     12.1. The Pakam Platform is provided on an "as is" and “as available”
    //     basis. We do not represent, warrant or guarantee that access to Pakam
    //     Platform will be uninterrupted or error free. As the usage of Pakam
    //     Platform for requesting collection services depends on the behavior of
    //     generators, we do not guarantee that your usage of the Pakam Platform
    //     will result in any Collection Service requests.
    //   </BodyP>
    //   <BodyP>
    //     12.2. To the maximum extent permitted under the applicable law, we, nor
    //     Pakam’s representatives, directors and employees are not liable for any
    //     loss or damage that you may incur as a result of using the Pakam
    //     Services, including but not limited to:
    //   </BodyP>
    //   <BodyP>
    //     12.2.1. any direct or indirect property damage or monetary loss; 12.2.2.
    //     loss of profit or anticipated savings;
    //   </BodyP>
    //   <BodyP>
    //     12.2.3. loss of business, contracts, contacts, goodwill, reputation and
    //     any loss that may arise from interruption of the business;
    //   </BodyP>
    //   <BodyP>
    //     12.2.4. loss or inaccuracy of data; and 12.2.5. any other type of loss
    //     or damage.
    //   </BodyP>
    //   <BodyP>
    //     12.3. The financial liability of us in connection with violating the
    //     General Terms or Agreement will be limited to 5000 Naira. You shall have
    //     the right to claim for damages only if we have deliberately violated the
    //     General Terms or Agreement.
    //   </BodyP>
    //   <BodyP>
    //     12.4. We shall not be liable for the actions or non-actions of the
    //     Generators and shall not be liable for any loss or damage that may incur
    //     to you or your asset as a result of actions or non-actions of the
    //     generator.
    //   </BodyP>
    //   <BodyP>
    //     12.5. You shall be fully liable for breach of the General Terms,
    //     Agreement or any other applicable laws or regulations and must stop and
    //     remedy such breach immediately after receipt of a respective demand from
    //     us or any state authority. You shall indemnify us for any direct and/or
    //     indirect loss and/or damage, loss of profits, expense, penalty, fine
    //     that we may occur in connection with your breach of the General Terms,
    //     Agreement and laws and regulations. If Passenger presents any claims
    //     against us in connection with your provision of Collection Services,
    //     then you shall compensate such damage to us in full within 7 (seven)
    //     days as of your receipt of the respective request from us. In case we
    //     are entitled to present any claims against you, then you shall
    //     compensate us any legal costs related to evaluation of the damages and
    //     submission of claims relating to compensation for such damage.
    //   </BodyP>
    //   <Bodyh6>13. TERM, SUSPENSION AND TERMINATION</Bodyh6>
    //   <BodyP>
    //     13.1. The conditions expressly specified in these General Terms shall
    //     enter into force as of submitting the signup application. Agreements and
    //     other terms shall enter into force once the specific document or message
    //     has been made available to you and you commence or continue providing
    //     Collection Services on Pakam Platform.
    //   </BodyP>
    //   <BodyP>
    //     13.2. You may terminate the Agreement at any time by notifying Pakam at
    //     least 7 (seven) days in advance, after which your right to use the Pakam
    //     Platform and Pakam Services shall terminate. Pakam may terminate the
    //     Agreement at any time and for any reason at the sole discretion of us by
    //     notifying you at least 3 (three) days in advance.
    //   </BodyP>
    //   <BodyP>
    //     13.3. Pakam is entitled to immediately terminate the Agreement and block
    //     your access to the Pakam Platform without giving any advance notice in
    //     case you breach the General Terms or Agreement, any applicable laws or
    //     regulations, disparage Pakam, or cause harm to Pakam’s brand, reputation
    //     or business as determined by Pakam in our sole discretion. In the
    //     aforementioned cases we may, at own our discretion, prohibit you from
    //     registering a new Collector account.
    //   </BodyP>
    //   <BodyP>
    ...
    //     period of investigation, if we suspect an infringement of the Agreement
    //     or fraudulent activity from your behalf. The block of access will be
    //     removed once the investigation disproves such suspicions.
    //   </BodyP>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <Bodyh6>14. AMENDMENTS</Bodyh6>
    //   <BodyP>
    //     14.1. Pakam reserves the right to amend these General Terms anytime by
    //     uploading the revised version on its website
    //     https://pakam.ng/terms-and-conditions and notifying you (e.g. via
    //     e-mail, Pakam App or Pakam collectors Account) whenever, in the
    //     reasonable opinion of Pakam, such amendments are material.
    //   </BodyP>
    //   <BodyP>
    //     14.2. Pakam shall provide at least 15 days advance notice (e.g., via
    //     e-mail, Pakam App or Pakam Collectors Account) about the amendments that
    //     affect the rights of Business Users Operating in the Member State,
    //     unless:
    //   </BodyP>
    //   <BodyP>
    //     14.2.1. Pakam is subject to a legal or regulatory obligation which
    //     requires it to amend the General Terms in a manner which does not allow
    //     it to respect the advance notice period.
    //   </BodyP>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <BodyP>
    //     14.2.3. you have elected to waive the advance notice period (e.g. you
    //     continue to use Pakam Services after receipt of the notice of
    //     amendment); or 14.2.4. in the reasonable opinion of Pakam, amendments
    //     are beneficial for the Collector and do not require technical
    ...
    //     effect on the effective date of the proposed amendment, unless otherwise
    //     provided in your termination notice. Your use of the Pakam Services on
    //     or after the effective date of the amendment constitutes your consent to
    //     be bound by the General Terms or Agreement, as amended.
    //   </BodyP>
    //   <Bodyh6>15. APPLICABLE LAW AND COURT JURISDICTION</Bodyh6>
    //   <BodyP>
    //     15.1. The General Terms and Agreement shall be governed by and construed
    //     and enforced in accordance with the laws of Federal Republic of Nigeria.
    //     If the respective dispute resulting from General Terms or Agreement
    //     could not be settled by negotiations, then the dispute shall be solved
    //     in Federal high Court.
    //   </BodyP>
    //   <Bodyh6>16. NOTICES</Bodyh6>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <BodyP>16.2.1. delivered personally,</BodyP>
    //   <BodyP>16.2.2. sent by courier with proof of delivery,</BodyP>
    //   <BodyP>16.2.3. sent by registered mail,</BodyP>
    //   <BodyP>16.2.4. sent by e-mail or</BodyP>
    //   <BodyP>
    //     16.2.5. made available via the Pakam App or Pakam Collectors Account.
    //   </BodyP>
    //   <BodyP>
    ...
    //   </BodyP>
    //   <BodyP>
    //     16.3.2. if delivered by courier, on the date stated by the courier as
    //     being the date on which the envelope containing the notice was delivered
    //     to the party; 16.3.3. if sent by registered mail, on the 10th day after
    //     handing the document over to the post office for delivery to the party;
    //   </BodyP>
    //   <BodyP>
    //     16.3.3. if made available via the Pakam App or Pakam Collectors Account,
    //     or
    //   </BodyP>
    //   <BodyP>
    //     16.3.4. if sent by e-mail, on the day the party receiving the e-mail
    //     confirms receiving the respective e-mail or on the 2nd day following the
    //     dispatch of the e-mail provided that the sender has not received an
    //     error notice (notifying that the e-mail was not delivered to the party)
    //     and has sent the e-mail again on the next calendar day and has not
    //     received a similar error notice.
    //   </BodyP>
    //   <Bodyh6>17. FINAL PROVISIONS</Bodyh6>
    //   <BodyP>
    ...
    //     affected provision. Date of entry into force of the General Terms:
    //     10.09.2022.
    //   </BodyP>
    // </TermsCollectorSection>
