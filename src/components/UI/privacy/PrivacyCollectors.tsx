...
import { Wrapper } from "./PrivacyGenerators";
      ...
      <Wrapper>
        <div>
          <p className="pt-4">
            ...
            Officer <a href="mailto:privacy@pakam.ng">(privacy@pakam.ng)</a>.
        ...
        <div>
          <h4>2. Purposes of the processing</h4>
          <p>
            <ul>
              <li>
        ...
        <div>
          <h4>6. Processing generators personal data</h4>
          <p>
            <ul>
              <li>
                You may not process the personal data of generator without the
          ...
          <p>
            <ul>
              <li>
                ...
                <a href="mailto:info@pakam.ng"> (info@pakam.ng)</a> or by
                contacting Pakam Operations Data Protection Officer
                <a href="mailto:privacy@pakam.ng"> (privacy@pakam.ng)</a>
              </li>
            </ul>
          </p>
        </div>
