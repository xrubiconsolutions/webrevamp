  ...
  return (
    <Container>
      ...
      <BodyP>
        ...
        binding agreement between you ("End User" or "you") and Xrubicon
        Solutions Limited. ("Company"). This Agreement governs your use of the
        Xrubicon supply of Pakam mobile application for Apple iOS or Google
        Android operating systems (including all related documentation, the
        "Application"). Pakam is built as a freemium application by Xrubicon
        solutions limited.
      </BodyP>
      <BodyP>
        BY DOWNLOADING/INSTALLING/USING THE APPLICATION, YOU (A) ACKNOWLEDGE
        ...
        NOT AGREE TO THESE TERMS, DO NOT DOWNLOAD/ INSTALL/USE THE APPLICATION.
      </BodyP>
      <BodyP>
        <p>
          ...
          commercial use on a single mobile device owned or otherwise controlled
          by you ("Mobile Device") strictly in accordance with the Application's
          documentation.
        </p>
      </BodyP>
      <BodyP>
        2. License Restrictions. Licensee shall not: (a) copy the Application,
        ...
        not patentable, of the Application; (c) reverse engineer, disassemble,
        ...
        Application available on a network where it is capable of being accessed
        by more than one device at any time; or (f) remove, disable, circumvent
      ...
      <BodyP>
        ...
        <a
          href="https://www.pakam.ng/resources/documents/mobile-app-ssa-privacy-policy/."
          target="_blank"
        >
          https://www.pakam.ng/resources/documents/mobile-app-ssa-privacy-policy/.
        </a>
      ...
      <BodyP>
        ...
        download/install the Application and will continue in effect until
        terminated by you or Company as set forth in this Section 6. (b) You may
        terminate this Agreement by deleting the Application and all copies
        thereof from your Mobile Device. (c) Company may terminate this
        Agreement at any time without notice if it ceases to support the
        Application, which Company may do in its sole discretion. In addition,
        this Agreement will terminate immediately and automatically without any
        ...
        account. (e) Termination will not limit any of Company's rights or
      ...
      <BodyP>
        ...
        LIABILITY FOR DAMAGES ARISING FROM OR RELATED TO YOUR USE OF OR
        INABILITY TO USE THE APPLICATION. THE FOREGOING LIMITATIONS WILL APPLY
      ...
      <BodyP>
        ...
        misuse of the Application or your breach of this Agreement. Furthermore,
        you agree that Company assumes no responsibility for the content you
        submit or make available through this Application.
      </BodyP>
      <BodyP>
        10. Export Regulation. The Application may be subject to Nigeria export
        regulation, including the Nigeria Export Council Act and its associated
        regulations if applicable. You shall not, directly or indirectly,
      ...
      <BodyP>
        ...
        accordance with the internal laws of Lagos State without giving effect
        ...
        Application shall be instituted exclusively in the federal high courts
        of Nigeria or the Ikeja high courts of Lagos state in each case located
        in Lagos state. You waive any and all objections to the exercise of
        jurisdiction over you by such courts and to venue in such courts.{" "}
      </BodyP>
      <BodyP>
        13. Entire Agreement. This Agreement and our Privacy Policy constitute
      ...
      <BodyP>
        14. Waiver. No failure to exercise, and no delay in exercising, on the
        part of either party, any right or any power hereunder shall operate as
        a waiver thereof, nor shall any single or partial exercise of any right
        or power hereunder preclude further exercise of that or any other right
