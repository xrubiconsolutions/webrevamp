...
export const solutions: Array<TechnologyModel> = [
  ...
  },
  {
    ...
    text: "Reckless disposal of waste that clogs drainage, causes flooding, transmit diseases, harm life on land, and below the sea.",
  },
  {
    isTitle: false,
    imgUrl: "/img/SheetpaperTrash.png",
    title: "Delay in waste collection",
    text: "Delay in waste collection which leads to the overflow of waste bin and comes with attendant health issues. ",
  },
  {
    isTitle: false,
